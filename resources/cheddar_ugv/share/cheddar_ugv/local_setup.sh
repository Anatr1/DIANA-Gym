...
: ${AMENT_CURRENT_PREFIX:="/PATH/TO/DIANA-Gym/resources/cheddar_ugv"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cheddar_ugv/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/cheddar_ugv/environment/path.sh"
