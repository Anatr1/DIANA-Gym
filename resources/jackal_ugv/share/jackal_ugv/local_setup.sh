...
: ${AMENT_CURRENT_PREFIX:="/PATH/TO/DIANA-Gym/resources/jackal_ugv"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jackal_ugv/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jackal_ugv/environment/path.sh"
