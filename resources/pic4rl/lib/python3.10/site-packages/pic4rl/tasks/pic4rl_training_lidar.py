...
class Pic4rlTraining_Lidar(Pic4rlEnvironmentLidar):
    ...
    def instantiate_agent(self):
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent()")
        action =[
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() action: ", action)
        low_action = []
        high_action = []
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() low_action: ", low_action)
        low_action = np.array(low_action, dtype=np.float32)
        high_action = np.array(high_action, dtype=np.float32)

        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() high_action: ", high_action)
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() self.action_space: ", self.action_space)
        state =[
        [0., 15.], # goal_distance 
        [-math.pi, math.pi], # goal angle or yaw
        ]

        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() state: ", state)
        for i in range(self.lidar_points):
            state = state + [[0., 12.]]

        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() state2: ", state)
        if len(state)>0:
            low_state = []
            high_state = []
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() self.low_state: ", self.low_state)
        ...
        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() self.observation_space: ", self.observation_space)
        #self.print_log()

        print("DEBUG: Pic4rlTraining_Lidar: instantiate_agent() self.train_policy: ", self.train_policy)
